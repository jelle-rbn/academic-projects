# Setup guide for first startup - Iteration 1
...
2. Connect to the router and perform "Bootstrap"

3. Connect to the switch and perform "Bootstrap"

4. Connect to the router and download R1-config.txt

5. Connect to the switch and download S1-config.txt
