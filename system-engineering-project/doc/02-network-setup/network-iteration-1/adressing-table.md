...
- Default gateway ISP: `192.168.132.254/30`
- Uplink interface: `192.168.132.253/30`

### VLAN 1

VLAN 1 contains the switch, router and the TFTP server
...
Vlan 22 is used for clients (using DHCP).
